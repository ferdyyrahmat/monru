    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.syarat.ruang.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12 mb-5">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="name" class="form-control mb-3 mb-lg-0" placeholder="masukkan nama syarat" />
                                <!--end::Input-->
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="row row-cols-1 row-cols-md-3">
                                <div class="col mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="syarat_suhu" class="form-control mb-3 mb-lg-0" placeholder="masukkan syarat" />
                                    <!--end::Input-->
                                </div>
                            </div>
                            <div class="row row-cols-1 row-cols-md-3">
                                <div class="col mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" step="any" name="batas_bawah_suhu_alert" class="form-control mb-3 mb-lg-0" placeholder="masukkan batas suhu" />
                                    <!--end::Input-->
                                </div>
                                <div class="col mb-5">
                                    <!--begin::Label-->
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" step="any" name="batas_bawah_suhu_action" class="form-control mb-3 mb-lg-0" placeholder="masukkan batas suhu" />
                                    <!--end::Input-->
                                </div>
                            </div>
                            <div class="row row-cols-1 row-cols-md-3">
                                <div class="col mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" step="any" name="batas_atas_suhu_alert" class="form-control mb-3 mb-lg-0" placeholder="masukkan batas suhu" />
                                    <!--end::Input-->
                                </div>
                                <div class="col mb-5">
                                    <!--begin::Label-->
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" step="any" name="batas_atas_suhu_action" class="form-control mb-3 mb-lg-0" placeholder="masukkan batas suhu" />
                                    <!--end::Input-->
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="row row-cols-1 row-cols-md-3">
                                <div class="col mb-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="syarat_rh" class="form-control mb-3 mb-lg-0" placeholder="masukkan syarat" />
                                    <!--end::Input-->
                                </div>
                            </div>
                            <div class="row row-cols-1 row-cols-md-3">
