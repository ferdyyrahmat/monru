...
@section('main-content')
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-fluid d-flex flex-column flex-column-fluid">
            <form action="{{ route('admin.jenis.dp.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="d-flex flex-column mb-5">
                                        ...
                                        <!--end::Label-->
                                        <input type="text" class="form-control" name="name" id="jenis_ruangan"
                                            placeholder="masukkan jenis dp">
                                    </div>
                                    <!--end::Input group-->
                                </div>
                                <div class="col">
