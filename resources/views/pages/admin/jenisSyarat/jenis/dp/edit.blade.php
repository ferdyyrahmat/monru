...
@section('main-content')
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-fluid d-flex flex-column flex-column-fluid">
            <form action="{{ route('admin.jenis.dp.update', $jenisDp->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="d-flex flex-column mb-5">
                                        <!--begin::Label-->
                                        <label class="d-flex align-items-center fs-5 fw-semibold mb-2" for="jenis_dp">
                                            <span class="required text-gray-700">Jenis Dp</span>
                                        </label>
                                        <!--end::Label-->
                                        <input type="text" class="form-control" name="name" id="jenis_dp"
                                            placeholder="masukkan jenis dp" value="{{ $jenisDp->name }}">
                                    </div>
                                    <!--end::Input group-->
                                </div>
                                <div class="col">
                                    ...
                                    <div class="d-flex flex-column mb-5">
                                        ...
                                        <select name="id_syarat" id="syarat" class="form-select form-select">
                                            ...
                                            @foreach ($syarat as $item)
                                                <option value="{{ $item->id }}" {{ $jenisDp->id_syarat == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                        <!--end::Select-->
                                    </div>
