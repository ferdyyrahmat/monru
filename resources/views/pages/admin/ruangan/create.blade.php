                                ...
                                <div class="col">
                                    <div class="col">
                                        ...
                                        <div class="d-flex flex-column mb-5">
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control" name="area_name" id="area_name" placeholder="masukkan nama area">
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                </div>
                            ...
                            <div class="row row-cols-1 row-cols-lg-3">
                                <div class="col">
                                    ...
                                    <div class="d-flex flex-column mb-5">
                                        ...
                                        <!--end::Label-->
                                        <input type="number" class="form-control" name="room_no" id="room_no" placeholder="masukkan no. ruangan">
                                    </div>
                                    <!--end::Input group-->
                                </div>
                                <div class="col">
                                    ...
                                    <div class="d-flex flex-column mb-5">
                                        ...
                                        <!--end::Label-->
                                        <input type="text" class="form-control" name="no_alat" id="no_alat" placeholder="masukkan no. alat">
                                    </div>
                                    <!--end::Input group-->
                                </div>
                                <div class="col">
