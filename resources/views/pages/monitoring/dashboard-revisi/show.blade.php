        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Revision</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                ...
                <div class="col">
                    <div class="card card-stretch">
                        ...
                        <div class="card-body card-scroll">
                            <table id="dt_revisi" class="table table-bordered table-striped align-middle">
                                <thead>
            ...
            <div class="modal-content">
                ...
                {{-- <form id="view_modal_form" action="" method="POST" class="form"> --}}
                    <div class="modal-body px-5">
                        <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="view_modal_scroll"
                            data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto"
                            data-kt-scroll-dependencies="#view_modal_header"
                            data-kt-scroll-wrappers="#view_modal_scroll" data-kt-scroll-offset="300px">
                            <div class="row mb-2">
...
@section('scripts')
    ...
    <script>
        ...
        const URL = "{{ route('v1.monitoring.revisi.getTableData') }}";
        let shift;
        let month;
        let year;
        let ruang;
        ...
        function _init()
        {
            const URL = "{{ route('v1.monitoring.revisi.show', ':id') }}";
            month = $('#f_month').val();
            year = $('#f_year').val();
            ruang = $('#id_ruang').val();
            shift = $('#f_shift').val();
        ...
        var dt_revisi = $("#dt_revisi").DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: URL,
    ...
    <script>
        ...
        {
            $.ajax({
                url: "{{ route('v1.monitoring.revisi.index') }}",
                type: "GET",
                data: {
                    id: id,
                    _token: "{{ csrf_token() }}",
        ...
        function approved() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{route('v1.monitoring.revisi.approved')}}",
                        type: "POST",
                        data: {
                            id: id_detail,
                            _token: "{{ csrf_token() }}",
        ...
        function rejected() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{route('v1.monitoring.revisi.rejected')}}",
                        type: "POST",
                        data: {
                            id: id_detail,
                            _token: "{{ csrf_token() }}",
