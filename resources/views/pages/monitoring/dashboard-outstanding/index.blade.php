                            ...
                            @foreach ($department as $item)
                                <div class="col">
                                    ...
                                    <label
                                        ...
                                        <span class="text-center d-flex align-items-center justify-content-center fw-semibold">
...
@section('scripts')
    <script>
        function showData() {
                ...
                const URL = "{{ route('v1.monitoring.outstanding.show', ':id') }}"; // Construct the URL with the ID
